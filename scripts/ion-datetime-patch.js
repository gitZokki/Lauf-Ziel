 ...
 * !!! *****CHANGES***** !!!
 *
 * SEE PATCHES AND USE 'npx patch-package @ionic/core'
 *
 */
...
(self['webpackChunkapp'] = self['webpackChunkapp'] || []).push([
  ...
  \*******************************************************************/
			/***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
				...
				/* harmony import */ var _home_oem_Desktop_VSCode_lauf_ziel_App_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ =
				...
				/* harmony import */ var _ionic_global_00475c3a_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
					/*! ./ionic-global-00475c3a.js */ 537
				);
				/* harmony import */ var _focus_visible_5ad6825d_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
					/*! ./focus-visible-5ad6825d.js */ 9013
				);
				...
				/* harmony import */ var _overlays_ab6211c7_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
					/*! ./overlays-ab6211c7.js */ 9703
				);
				/* harmony import */ var _animation_36c1d77d_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
					/*! ./animation-36c1d77d.js */ 2597
				);
				/* harmony import */ var _haptic_683b3b3c_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./haptic-683b3b3c.js */ 634);
				/* harmony import */ var _hardware_back_button_490df115_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
					/*! ./hardware-back-button-490df115.js */ 159
				);
				...
				const warnIfValueOutOfBounds = (value, min, max) => {
					if ((min && isBefore(value, min)) || (max && isAfter(value, max))) {
						(0, _index_9ac92660_js__WEBPACK_IMPORTED_MODULE_6__.p)(
				...
				const Datetime = class {
					constructor(hostRef) {
						...
						this.getCalendarBodyEl = () => {
							...
							return (
								this.calendarBodyRef || ((_a = this.el.shadowRoot) === null || _a === void 0 ? void 0 : _a.querySelector('.calendar-body'))
							);
						};
						...
						this.initializeKeyboardListeners = () => {
							...
							const checkCalendarBodyFocus = ev => {
								...
								if (
									((_a = record.oldValue) === null || _a === void 0 ? void 0 : _a.includes('ion-focused')) ||
						...
						this.initializeCalendarListener = () => {
							...
							(0, _index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_1__.c)(() => {
								calendarBodyRef.scrollLeft =
									startMonth.clientWidth * ((0, _dir_e8b767a8_js__WEBPACK_IMPORTED_MODULE_7__.i)(this.el) ? -1 : 1);
								...
								const updateActiveMonth = () => {
									...
									(0, _index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_1__.c)(() => {
										...
										calendarBodyRef.scrollLeft =
											workingMonth.clientWidth * ((0, _dir_e8b767a8_js__WEBPACK_IMPORTED_MODULE_7__.i)(this.el) ? -1 : 1);
					...
					valueChanged() {
						if (this.hasValue()) {
							...
							if (valueDateParts) {
								...
								(0, _index_9ac92660_js__WEBPACK_IMPORTED_MODULE_6__.p)(
									`Unable to parse date string: ${this.value}. Please provide a valid ISO 8601 datetime string.`
								);
							}
						}
					...
					confirm(closeOverlay = false) {
						...
						return (0,
						_home_oem_Desktop_VSCode_lauf_ziel_App_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__[
							'default'
						])(function* () {
							/**
					...
					componentDidLoad() {
						...
						(0, _helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_5__.r)(() =>
							visibleIO === null || visibleIO === void 0 ? void 0 : visibleIO.observe(this.el)
						);
						/**
						...
						(0, _helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_5__.r)(() =>
							hiddenIO === null || hiddenIO === void 0 ? void 0 : hiddenIO.observe(this.el)
						);
						/**
					...
					renderFooter() {
						...
						return (0, _index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_1__.h)(
							'div',
							{
								class: 'datetime-footer',
							},
							(0, _index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_1__.h)(
								'div',
								{
										...
										(0, _index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_1__.h)('ion-picker-column-internal', {
											...
											onIonChange: ev => {
												...
												if (presentation === 'month' || presentation === 'month-year') {
													this.setActiveParts(
														Object.assign(Object.assign({}, this.activeParts), {
															month: ev.detail.value,
														})
													);
								...
								getDaysOfMonth(month, year, this.firstDayOfWeek % 7).map((dateObject, index) => {
									...
									if (!isCalDayDisabled && isDateEnabled !== undefined) {
										try {
											...
											(0, _index_9ac92660_js__WEBPACK_IMPORTED_MODULE_6__.b)(
						...
						return (0, _index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_1__.h)(
							...
							(0, _index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_1__.h)('ion-picker-column-internal', {
								...
								onIonChange: ev => {
									...
									this.setActiveParts(
										Object.assign(Object.assign({}, activePartsClone), {
											hour: ev.detail.value,
										})
									);
									ev.stopPropagation();
					...
					render() {
						...
						return (0, _index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_1__.h)(
							_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_1__.H,
							{
								...
								class: Object.assign(
									{},
									(0, _theme_7670341c_js__WEBPACK_IMPORTED_MODULE_8__.c)(color, {
										[mode]: true,
				...
				const Picker = class {
					...
					present() {
						...
						_home_oem_Desktop_VSCode_lauf_ziel_App_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__[
							...
							yield (0,
							_overlays_ab6211c7_js__WEBPACK_IMPORTED_MODULE_9__.d)(_this5, 'pickerEnter', iosEnterAnimation, iosEnterAnimation, undefined);
					...
					dismiss(data, role) {
						...
						return (0, _overlays_ab6211c7_js__WEBPACK_IMPORTED_MODULE_9__.f)(
							this,
							data,
							role,
							'pickerLeave',
						...
						return (0, _index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_1__.h)(
							...
							(0, _index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_1__.h)(
								...
								(0, _index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_1__.h)(
									...
									this.presented &&
										this.columns.map(c =>
											(0, _index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_1__.h)('ion-picker-column', {
												col: c,
											})
										),
									(0, _index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_1__.h)('div', {
				...
				const PickerColumnCmp = class {
					...
					connectedCallback() {
						...
						_home_oem_Desktop_VSCode_lauf_ziel_App_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__[
							...
							_this8.gesture = (yield Promise.resolve(/*! import() */).then(
								__webpack_require__.bind(__webpack_require__, /*! ./index-3f1a7d95.js */ 2172)
							)).createGesture({
								el: _this8.el,
					...
					onEnd(detail) {
						...
						this.velocity = (0, _helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_5__.l)(
							-MAX_PICKER_SPEED,
							detail.velocityY * 23,
							MAX_PICKER_SPEED
						);
